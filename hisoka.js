...
module.exports = hisoka = async (hisoka, m, chatUpdate, store) => {
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await hisoka.setStatus(`${'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜'} | Runtime : ${runtime(uptime)}`)
    ...
    ${isSurender ? '' : `Perfect Player`}`.trim()
        ...
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await hisoka.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'TEBAK LAGU' }, type: 1 }], `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', m)
...
case 'cekmati':
            ...
            case 'tebak': {
                ...
                if (args[0] === "lagu") {
                    ...
                    hisoka.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'TEBAK LAGU' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', m)
                    delete tebaklagu[m.sender.split('@')[0]]
                    }
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, jawab, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', m, {mentions: ments})
            }
            break
            case 'jadian': {
            if (!m.isGroup) throw mess.group
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, jawab, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', m, {mentions: menst})
            }
            break
            case 'react': {
                if (!isCreator) throw mess.owner
...
let buttonsVote = [
  ...
  {buttonId: `${prefix}devote`, buttonText: {displayText: '𝙳𝙴𝚅𝙾𝚃𝙴'}, type: 1}
            ...
            let buttonMessageVote = {
                text: teks_vote,
                footer: 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜',
                buttons: buttonsVote,
                headerType: 1
            }
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            break
               case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `Mode Group`, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', m)
            ...
            case 'editinfo': {
             ...
             let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `Mode Edit Info`, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', m)
            ...
            case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `Mode Antilink`, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', m)
                }
             }
             break
             case 'mute': {
                ...
                m.reply(`${'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜'} telah di mute di group ini !`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return m.reply(`Sudah Tidak Aktif Sebelumnya`)
                db.data.chats[m.chat].mute = false
                m.reply(`${'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜'} telah di unmute di group ini !`)
                } else {
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'ON' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'OFF' }, type: 1 }
                    ]
                    await hisoka.sendButtonText(m.chat, buttons, `Mute Bot`, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', m)
                }
             }
             break
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                ...
                                quickReplyButton: {
                                    displayText: 'Lιʂƚ ɱҽɳυ ☕',
                                    id: 'command'
                                }
                            }]
                      let txt = `「 Broadcast Bot 」\n\n${text}`
                      hisoka.send5ButImg(i, txt, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', global.thumb, btn)
                    }
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                      ...
                      let txt = `「 Broadcast Bot 」\n\n${text}`
                      hisoka.send5ButImg(yoi, txt, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', global.thumb, btn)
		}
...
case 'stext': case 'stickertext': case 'stikertext': {
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            hisoka.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜'}.mp3`}, { quoted : m })
            }
            break
...
Lihat list Pesan Dengan ${prefix}listmsg`)
	    ...
	    case 'anonymous': {
                ...
                hisoka.sendButtonText(m.chat, buttons, `\`\`\`Hi ${await hisoka.getName(m.sender)} Welcome To Anonymous Chat\n\nKlik Button Dibawah Ini Untuk Mencari Partner\`\`\``, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', m)
            }
			break
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `\`\`\`Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda\`\`\``, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await hisoka.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await hisoka.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', m)
                }
                break
            }
...
let btn = [{
                ...
                hisoka.send5ButImg(m.chat, anu, 'R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜', global.thumb, btn)
            }
            break
case 'sewabot': {
	anu = `╭──「 *_SEWA BOT BY R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜_* 」
│❏ ➪ _1 MINGGU : 1K_
│❏ ➪ _1 BULAN : 5K_
│❏ ➪ _PERMANEN : 10k_
╰────
...
╰──── 
╭─[ *MINAT CHAT📌*]
│❏ ➪ 🪀 _wa.me/682252285143?text=SEWA+BOT_
╰────
╭─[ *PAYMENT💰*]
│❏ ➪ _GA TAU_
╰────`
              let btn = [{
                        ...
                        hisoka.send5ButImg(m.chat, anu, 'Gα ƚαυ Aρααɳ', global.thumb, btn)
                     }
            break
  case 'menu': {
	anu = `Hai Kak ${pushname}\n\nSaya Adalah R̵̢̮̺̫͕̼͊̂͊̋ͅy̷̦̼̘̔̅́̾͂ą̴̢̹̣̤͍̬̘͌̉̓́̚͜͝n̵̻̘̳̱̫̳̺̞͈̈ ̷̺̥͙̀̈́̈́͊̓̿͘͝A̶̙̮͓͍͒d̵̨̦̎̅͌͑̄̃̋̚į̸͍̞̘͐̉͑̍̚t̶̝̝͑͆̀͋̽̿̿̇͝͝ͅy̴̖̮̜͉̻̳͕̍ą̴̲̞̝̤͖̠͂̄́̉̽̂̎͜, Bot Ini Memakai Program Multi Device Beta Dari WhatsApp.\n\nJadi Jika Kamu Menemukan Bug Atau Kesalahan Silahkan Laporkan Kepada Owner Agar Segera Di Perbaiki.\n\nTerima Kasih🙏`
              let btn = [{
                                urlButton: {
                                    displayText: 'ƓƦƲƤ ƠƑƇ ☔',
                                    url: 'https://chat.whatsapp.com/B9cQxA0NWrXHtFclMS5awJ'
